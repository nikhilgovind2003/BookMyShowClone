    ...
    <>
      <div className="container w-full flex justify-between items-center m-auto">
        <div className="flex gap-4 items-center w-full">
          ...
          <div className="w-[600px] bg-white flex items-center px-3 py-2 gap-3 rounded-sm">
...
function NavBar() {
  return (
    <>
      <nav className="bg-navcolor-900 py-4 px-40">
      ...
      <div className="py-1 flex justify-around bg-navcolor-800">
        <div>
