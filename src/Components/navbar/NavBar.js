        ...
        <div className='text-white flex justify-between items-center'>
            <div>
                <div>
                    ...
                    <span className='text-white flex items-center text-xs mt-1'>Kochi <BiChevronRight /></span>
                </div>
            </div>
            <div className='flex items-center gap-5'>
                <button className='text-white font-bold bg-red-500 p-2 text-xs rounded-lg'>Use App</button>
...
const NavLg = ()=>{
    return(
        ...
        <div className='w-full px-30'>
            <div className="container w-full flex justify-between items-center m-auto pb-5">
                ...
                <div className='flex items-center gap-3'>
                    <span className='hover:cursor-pointer text-white flex items-center text-xs'>Kerala <BiChevronDown/></span>
                    <button className="w-16 bg-red-600 text-white py-1 px-2 text-sm rounded hover:cursor-pointer">Sign In</button>
...
function NavBar() {
  return (
    <>
        <nav className='bg-navcolor-900 px-0 pb-0 py-3'>
