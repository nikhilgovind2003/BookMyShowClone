    ...
    <div className="text-white flex justify-between items-center">
      <div>
        <div>
          ...
          <span className="text-white flex items-center text-xs mt-1">
            Kochi <BiChevronRight />
          </span>
        </div>
      </div>
      <div className="flex items-center gap-5">
        <button className="text-white font-bold bg-red-500 p-2 text-xs rounded-lg">
          Use App
        </button>
        <div className="w-6 h-6 ">
          <BiSearch className="from-neutral-50 w-full h-full " />
        </div>
      </div>
    </div>
  );
...
const NavMd = () => {
  return (
    <div className="container bg-white flex items-center px-3 py-2 gap-3 rounded-sm">
      <BiSearch />
      <input
        type="search"
  ...
  return (
    <>
      <div className="w-full">
        <div className="container w-full flex justify-between items-center m-auto ">
          <div className="flex gap-4 items-center w-full">
            ...
            <div className="w-1/2 bg-white flex items-center px-3 py-1 gap-3 rounded-sm">
          ...
          <div className="flex items-center gap-3">
            <span className="hover:cursor-pointer text-white flex items-center text-xs">
              Kerala <BiChevronDown />
            </span>
            <button className="w-16 bg-red-500 text-white py-1 px-2 text-xs rounded hover:cursor-pointer">
              Sign In
            </button>
...
function NavBar() {
  return (
    <>
      <nav className="bg-navcolor-900 px-0P py-1 pb-0">
        <div className="md:hidden">
          {/* Mobile View */}
          <NavSm />
        </div>
        <div className="hidden py-1 lg:hidden md:flex">
          {/* Tablet View */}
          <NavMd />
        </div>
        <div className="hidden lg:block">
          {/* Desktop View */}
          <NavLg />
          <div className=" mt-1 py-1 flex justify-around bg-navcolor-800">
            <div>
